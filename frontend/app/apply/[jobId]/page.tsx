...
type UploadStatus = "idle" | "uploading" | "success";
 ...
 if (!profileData.isProfileComplete) {
   ...
   return; // Profil eksikse ilanı çekmeyi bırak ve redirect et
 }
 ...
 <div className="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-theme-1/10 border border-theme-1/20 mb-4">
